...
var yearText = svg.append('text')
    ...
    .style('stroke', 'white').style('fill', 'white')
    .style('text-anchor', 'start').text('2000');


function updateUnicef(data, year) {
    ...
    bubbles.enter().append(function(d) {
        ...
        document.getElementById('unicef-plot-surface').innerText = d['surface_water_national'] + '%';
        document.getElementById('unicef-plot-unimproved').innerText = d['unimproved_national'] + '%';
        document.getElementById('unicef-plot-limited').innerText = d['limited_national'] + '%';
        document.getElementById('unicef-plot-basic').innerText = d['at_least_basic_national'] + '%';
        document.getElementById('unicef-plot-population').innerText = (+d['population_thousands'] * 1000).toLocaleString();
